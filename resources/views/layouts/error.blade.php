...
<main class="container">
    <div class="red darken-2 white-text"
         style="padding: 20px;margin-bottom:20px; padding-top:50px; padding-bottom:50px;">
        @section('content')
    ...
    @section('button')
        <a href="/" class="waves-effect waves-light btn blue darken-2 center-align"
           style="width:80%;max-width:350px;margin-top:20px">{{ trans('messages.backhome') }}</a>
    @show
</main>
